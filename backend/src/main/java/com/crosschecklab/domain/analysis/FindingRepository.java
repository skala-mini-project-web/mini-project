...
public interface FindingRepository extends JpaRepository<Finding, Long> {
    ...
    List<Finding> findAllByAnalysisExecutionIdOrderByIdAsc(Long analysisExecutionId);

    List<Finding> findAllByAnalysisExecutionIdAndIdInOrderByIdAsc(
            Long analysisExecutionId, Collection<Long> ids);
